...
;copy translations end
  ...
  !define MUI_FILE "LoginScreenEditor"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Login Screen Editor Softpcapps"
  !define PRODUCT_SHORTCUT "Login Screen Editor Softpcapps"
  !define PRODUCT_VERSION "1.0"
  
  !define MUI_ICON "window_gear.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Login Screen Editor Softpcapps"
  OutFile "LoginScreenEditorSetup.exe"

  InstallDir "$PROGRAMFILES\softpcapps Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\softpcapps Software\Login Screen Editor Softpcapps" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Login Screen Editor Softpcapps - User's Manual.url.lnk" "$INSTDIR\Login Screen Editor Softpcapps - User's Manual.url" "" "$INSTDIR\Login Screen Editor Softpcapps - User's Manual.url" 0
...
;begin new uninstall strings
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\softpcapps Software\Login Screen Editor Softpcapps" "" $INSTDIR
  WriteRegStr HKLM "Software\softpcapps Software\Login Screen Editor Softpcapps" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\softpcapps Software\Login Screen Editor Softpcapps"
  DeleteRegKey HKCU "Software\softpcapps Software\Login Screen Editor Softpcapps"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://softpcapps.com/login-screen-editor/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "https://softpcapps.com/login-screen-editor/how-to-use.php?afterinstall=true"
FunctionEnd
