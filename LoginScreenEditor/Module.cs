...
namespace LoginScreenEditor
{
    class Module
    {
        ...
        public static string ApplicationName = "Login Screen Editor Softpcapps";
        ...
        public static string DownloadURL = "https://softpcapps.com/d/LoginScreenEditor/";
        public static string HelpURL = "https://softpcapps.com/login-screen-editor/how-to-use.php";
        public static string ProductWebpageURL = "https://softpcapps.com/login-screen-editor/";
        public static string BuyURL = "https://softpcapps.com/store/buy-login-screen-editor.php";
        public static string VersionURL = "http://cssspritestool.com/versions/login-screen-editor.txt";

        public static int NumberOfFilesProcessed = 0;

        public static string TipText = TranslateHelper.Translate("Great application to set legal notice and login image !");              
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "LoginScreenEditor");
